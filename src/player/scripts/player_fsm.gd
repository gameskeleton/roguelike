...
# @impure
func _init(in_player_node: RkPlayer, in_parent_state_node: Node, in_initial_state_node: RkStateMachineState) -> void:
...
# @impure
func set_state_node(state_node: RkStateMachineState) -> void:
